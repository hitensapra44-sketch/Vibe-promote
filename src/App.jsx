...
import BufferOAuthCallback from './pages/BufferOAuthCallback';
import PostizOAuthCallback from './pages/PostizOAuthCallback';
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/oauth/buffer/callback" element={<BufferOAuthCallback />} />
        <Route path="/oauth/postiz/callback" element={<PostizOAuthCallback />} />
