  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-10 right-0 z-10 rounded-0-xl border border-r-0 border-white/10 bg-[#1a1f2e] px-0.5 py-1 text-[11px] font-medium tracking-wide text-white shadow-md transition hover:bg-[#20283b] [writing-mode:vertical-rl] focus:outline-none focus:ring-2 focus:ring-[#6366f1] focus:ring-offset-1 focus:ring-offset-[#0f1117]"
      >
        Feedback
      </button>
