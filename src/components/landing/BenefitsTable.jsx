    ...
    <section id="benefits" className="py-24 px-4 sm:px-6 font-poppins bg-white"> 
      <div className="max-w-4xl mx-auto"> 
        ...
        <motion.div 
          ...
          className="mt-12 rounded-2xl overflow-hidden border border-zinc-200 w-full overflow-x-auto bg-zinc-50" 
        > 
          <div className="min-w-[600px] sm:min-w-0"> 
            ...
            <div className="grid grid-cols-3 text-center bg-zinc-100"> 
              ...
              <div className="px-4 py-5 text-sm font-semibold text-orange-500"> 
                Pre-Purchase Now<br /> 
                <span className="text-xs font-normal text-orange-400">(less than coffee)</span> 
              </div> 
            </div> 
