        ...
        <div className="max-w-4xl mx-auto w-full">
          ...
          {step === 2 && (
            <div className="animate-in fade-in slide-in-from-right-4 duration-500">
              <h1 className="text-2xl font-semibold text-white mb-8">How do you want to create your Indie Hackers post?</h1>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                >
                  ...
                  <p className="text-zinc-400 text-sm mt-2">Pick from 5 templates that are working right now on Indie Hackers</p>
                </div>
                <div
                ...
                >
                  ...
                  <p className="text-zinc-400 text-sm mt-2">Write your own draft and let AI improve it for Indie Hackers</p>
                </div>
              </div>
            </div>
          )}
              ...
              {selectedMode === "template" ? (
                <>
                  <div className="mb-8">
                    ...
                    <p className="text-zinc-400 text-sm">These formats are getting real traction on Indie Hackers</p>
                  </div>
...
<dyad-write path="src/pages/BrandBrainOnboarding2.jsx" description="Changing the color theme of BrandBrainOnboarding2 from indigo/blue to dark orange to match BrandBrainOnboarding.">
"use client";
