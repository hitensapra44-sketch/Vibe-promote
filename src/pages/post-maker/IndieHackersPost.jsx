...
`;
    ...
    if (parsed) {
      ...
      autoMarkTask(user.id, '/post-maker/indiehackers');

      // Mark onboarding milestone complete
      await completeOnboardingTask(user.id, 'create_post');
            ...
            <div className="mb-12">
              <div className="flex items-center justify-between mb-4">
                <div className="w-8 h-8">
                  <button 
                    onClick={handleBack}
                    className="p-2 -ml-2 rounded-lg hover:bg-foreground/5 text-foreground/60 hover:text-foreground transition-all bg-transparent border-none cursor-pointer"
                  >
            ...
            <div className="animate-in fade-in slide-in-from-right-4 duration-500">
              {selectedMode === "template" ? (
                      ...
                      <div key={i} className="bg-foreground/5 border border-foreground/10 rounded-xl p-5 flex flex-col gap-3">
                        <div className="flex items-center justify-between">
                          ...
                          <button
                            ...
                            className="bg-orange-500 text-white text-xs font-bold rounded-lg px-4 py-2 hover:bg-orange-600 transition-all border-none cursor-pointer"
                          >
                            Use This Template
                          </button>
                        </div>
                        ...
                        <div className="border-t border-foreground/10 pt-3">
                          <button 
                            ...
                            className="flex items-center gap-2 text-foreground/50 text-[10px] font-bold uppercase tracking-widest hover:text-foreground/80 transition-colors bg-transparent border-none cursor-pointer"
                          >
                ...
                <div className="space-y-6">
                  ...
                  <button
                    onClick={() => setStep(4)}
                    className="w-full py-4 bg-orange-500 text-white font-bold rounded-xl hover:bg-orange-600 transition-all border-none cursor-pointer"
                  >
                    Continue →
                  </button>
                </div>
                ...
                <div className="space-y-8 max-w-2xl">
                    ...
                    <div className="flex flex-wrap gap-3">
                      {[
                        ...
                        <button
                          ...
                          className={cn(
                            "px-5 py-2.5 rounded-full text-xs font-bold border transition-all bg-transparent cursor-pointer",
                            aiGoal === opt.id 
                              ? "bg-orange-500 border-orange-500 text-white shadow-lg shadow-orange-500/20" 
                              : "bg-foreground/5 border border-foreground/10 text-foreground/60 hover:border-zinc-600"
                          )}
                        >
                          {opt.label}
                        </button>
                  ...
                  <div className="pt-6">
                    <button
                      ...
                      className="w-full py-4 bg-orange-500 text-white font-bold rounded-xl hover:bg-orange-600 transition-all disabled:opacity-50 border-none cursor-pointer"
                    >
                      Continue →
                    </button>
                  </div>
              ...
              <div className="space-y-8">
                <div className="space-y-3">
                  ...
                  <textarea
                    value={customContext}
                    onChange={(e) => setCustomContext(e.target.value)}
                    className="w-full bg-foreground/5 border border-foreground/10 rounded-xl p-4 text-sm text-foreground min-h-[100px] focus:outline-none focus:border-orange-500 transition-all placeholder-zinc-600"
                  ...
                  <div className="flex flex-wrap gap-3">
                    {["Authentic Founder", "Bold & Punchy", "Educational", "Conversational"].map((t) => (
                      <button
                        ...
                        className={cn(
                          "px-5 py-2.5 rounded-full text-xs font-bold border transition-all cursor-pointer bg-transparent",
                          selectedTone === t 
                            ? "bg-orange-500 border-orange-500 text-white shadow-lg shadow-orange-500/20" 
                            : "bg-foreground/5 border border-foreground/10 text-foreground/60 hover:border-zinc-600"
                        )}
                ...
                <div className="pt-6 flex gap-4">
                  <button
                    ...
                    className="flex-1 py-4 border border-foreground/10 text-foreground/60 font-bold rounded-xl hover:bg-white/5 transition-all bg-transparent cursor-pointer"
                  >
                    Skip, just generate
                  </button>
                  <button
                    onClick={generatePost}
                    className="flex-[2] py-4 bg-orange-500 text-white font-bold rounded-xl hover:bg-orange-600 transition-all shadow-lg shadow-orange-500/20 border-none cursor-pointer"
                  >
                    Generate My Post →
                  </button>
                </div>
          ...
          {step === 6 && generatedPost && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-2xl mx-auto pb-20">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-2 justify-end pt-2">
                      <button
                        ...
                        className="px-4 py-2 rounded-lg border border-foreground/10 text-foreground/60 hover:text-foreground text-xs font-bold bg-transparent cursor-pointer"
                      >
                        Cancel
                      </button>
                      <button
                        ...
                        className="px-4 py-2 rounded-lg bg-orange-500 text-white text-xs font-bold border-none cursor-pointer"
                      >
                        Save
                      </button>
                    </div>
              ...
              <div className="flex flex-wrap gap-3 mt-8">
                <button 
                  onClick={handleCopy}
                  className="flex items-center justify-center gap-2 bg-foreground/5 border border-foreground/10 text-foreground/60 rounded-xl px-4 py-2.5 text-sm font-medium hover:border-zinc-600 transition-all cursor-pointer"
                >
                ...
                <a 
                  ...
                  className="flex items-center justify-center gap-2 bg-orange-500 text-white rounded-xl px-4 py-2.5 text-sm font-medium hover:bg-orange-600 transition-all no-underline"
                >
                ...
                <button 
                  onClick={resetAll}
                  className="text-foreground/50 text-xs font-medium hover:text-foreground/80 transition-colors bg-transparent border-none cursor-pointer"
                >
                  Start Over
                </button>
              </div>
