...
`;
    ...
    if (parsed) {
      ...
      autoMarkTask(user.id, '/post-maker/threads');
            ...
            <div className="mb-12">
              <div className="flex items-center justify-between mb-4">
                <div className="w-8 h-8">
                  <button 
                    onClick={handleBack}
                    className="p-2 -ml-2 rounded-lg hover:bg-white/5 text-foreground/60 hover:text-foreground transition-all bg-transparent border-none cursor-pointer"
                  >
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-3">
                  ...
                  <textarea
                    value={customContext}
                    onChange={(e) => setCustomContext(e.target.value)}
                    className="w-full bg-foreground/5 border border-foreground/10 rounded-xl p-4 text-sm text-foreground min-h-[100px] focus:outline-none focus:border-orange-500 placeholder-zinc-600"
          ...
          {step === 6 && generatedPost && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-2xl mx-auto pb-20">
                ...
                <div className="flex justify-between items-center">
                  ...
                  {!isEditingPost && (
                    <button
                      ...
                      className="p-1.5 hover:bg-foreground/5 rounded-md transition-all bg-transparent text-foreground/60 hover:text-foreground border-none cursor-pointer"
                    >
                ...
                {isEditingPost ? (
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-2 justify-end pt-2">
                      <button onClick={() => setIsEditingPost(false)} className="px-4 py-2 rounded-lg text-xs font-bold text-foreground/60 bg-transparent border-none cursor-pointer">Cancel</button>
                      <button
                        onClick={() => {
                          setGeneratedPost({
                            ...generatedPost,
              ...
              <div className="flex flex-wrap gap-3 mt-8">
                ...
                <a href="https://threads.net" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 bg-orange-500 text-white rounded-xl px-4 py-2.5 text-sm font-medium hover:bg-orange-600 transition-all no-underline">
                  <ExternalLink className="w-4 h-4" /> Open Threads
                </a>
                <button onClick={generatePost} className="flex items-center justify-center gap-2 bg-foreground/5 border border-foreground/10 text-foreground/60 rounded-xl px-4 py-2.5 text-sm font-medium hover:border-zinc-600 transition-all border-none cursor-pointer">
                  <RefreshCw className="w-4 h-4" /> Regenerate
                </button>
                <button onClick={resetAll} className="text-foreground/50 text-xs font-medium hover:text-foreground/80 transition-colors bg-transparent border-none cursor-pointer">Start Over</button>
              </div>
