...
const platformTemplates = {
  Threads: [
    { name: "The Relatable Moment", why: "Threads rewards short conversational posts under 150 chars per post. Relatability drives reshares.", structure: "Specific frustrating moment your audience has had → you know the one → one more line of relatability → we built [app name] because we were tired of it too → what changed" },
    { name: "The Honest Take", why: "Threads' algorithm weights meaningful replies heavily. 'Change my mind' ending is proven to trigger comment chains.", structure: "Hot take: [your opinion on something in your niche] → two lines expanding why → what you do instead → change my mind" },
    { name: "The Mini Story", why: "Threads is a storytelling platform at heart. Short personal stories with a clear arc outperform advice posts.", structure: "Specific moment told like a story opening → what happened next → the turn → what you learned or built because of it → still think about this a lot" },
    { name: "The Question That Starts A Thread", why: "Threads algorithm surfaces posts with early reply velocity. A genuine question from a founder gets replies fast.", structure: "Genuine question for [your audience] → question about a real problem in your niche → asking because [honest reason] → what's your experience been?" },
    { name: "The Before / After", why: "Before/after is the simplest high-converting format on Threads. Concise contrast + specific result.", structure: "Before [app name]: [painful status quo] → After [app name]: [the improvement] → specific result if you have one → still can't believe this wasn't easier before" }
  ]
};
              ...
              {selectedMode === "template" ? (
                <>
                  ...
                  <div className="space-y-4">
                    {platformTemplates.Threads.map((t, i) => (
