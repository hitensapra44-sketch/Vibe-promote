...
<dyad-write path="src/pages/post-maker/IndieHackersPost.jsx" description="Updating IndieHackersPost.jsx to use the new TemplateDetailCard component for a rich, structured template selection experience.">
"use client";
            ...
            <div className="animate-in fade-in slide-in-from-right-4 duration-500">
              {selectedMode === "template" ? (
                <>
                  ...
                  <div className="space-y-8">
                    {templatesData["Indie Hackers"].map((t) => (
                      <TemplateDetailCard 
                        key={t.id} 
                        template={t} 
                        onSelect={() => { setSelectedTemplate(t); setStep(4); }} 
