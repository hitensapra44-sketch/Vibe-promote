        ...
        <div className="p-6 sm:p-8 space-y-8 max-w-6xl mx-auto w-full">
          ...
          <section className="bg-[#111111] border border-orange-500/40 rounded-2xl p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col p-4 rounded-xl border border-white/5 bg-white/[0.02]">
                <span className="text-[10px] font-bold text-gray-600 uppercase tracking-widest mb-1">Role</span>
                <span className="text-base font-bold text-white">{profileData?.role || 'Not set'}</span>
              </div>
            </div>

            {/* Row 2 — Stats (4 cards) */}
            <div>
              <p className="text-[10px] font-bold text-gray-600 uppercase tracking-widest mb-3">Activity Stats</p>
                  ...
                  <div key={i} className="flex flex-col p-4 rounded-xl border border-white/5 bg-white/[0.02]">
                    <div className="flex items-center gap-2 mb-2">
                      <stat.icon className={cn(
                        "w-3.5 h-3.5",
                        stat.label === 'Day Streak' ? 'text-orange-500' : 'text-gray-500'
                      )} />
            ...
            {/* Row 3 — Channels */}
            <div>
              <p className="text-[10px] font-bold text-gray-600 uppercase tracking-widest mb-3">Target Channels</p>
            ...
            {/* Row 4 — Product Type + Marketing Focus */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col p-4 rounded-xl border border-white/5 bg-white/[0.02]">
                <span className="text-[10px] font-bold text-gray-600 uppercase tracking-widest mb-1">Product Type</span>
                <span className="text-sm font-bold text-white">{profileData?.productType || 'Not set'}</span>
              </div>
              <div className="flex flex-col p-4 rounded-xl border border-white/5 bg-white/[0.02]">
                <span className="text-[10px] font-bold text-gray-600 uppercase tracking-widest mb-1">Marketing Focus</span>
                <span className="text-sm font-bold text-white">{profileData?.focus || 'Not set'}</span>
              </div>
            </div>
