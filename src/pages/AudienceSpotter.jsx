...
DO NOT change anything else. No new files, no UI changes, no new API integrations.
      const userMsg = `
        App_Name: ${brainData.app_name}
        Description: ${brainData.app_description}
        Target_Customer: ${brainData.target_customer}
        Core_Problem: ${brainData.core_problem}
        Unique_Advantage: ${brainData.unique_differentiator}
        `;
