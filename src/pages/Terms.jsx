  ...
  return (
    <div style={{ background: 'var(--background)', minHeight: '100vh', padding: '80px 40px' }}>
      <div style={{ maxWidth: '760px', margin: '0 auto' }}>
        ...
        <h1 style={{ fontFamily: 'Inter', fontWeight: 900, fontSize: '40px', color: 'var(--foreground)', letterSpacing: '-0.03em', marginBottom: '8px' }}>Terms & Conditions</h1>
        <p style={{ fontFamily: 'Inter', fontSize: '14px', color: '#44403C', marginBottom: '20px' }}>Last updated: May 8, 2026</p>
        <p style={{ fontFamily: 'Inter', fontSize: '15px', color: 'var(--foreground)', opacity: 0.6, lineHeight: 1.8, marginBottom: '32px' }}>Welcome to Vibe Promote. By accessing or using our website and services, you agree to these Terms & Conditions. If you do not agree with these terms, do not use the platform.</p>
